export const routeList = [
  // 列表页
  { key:'index', title:'广场/推荐' },
  { key:'index-attention', title:'广场/关注' },
  { key: 'index-growth', title: '广场/成长' },
  ...
  // 详情页
  { key: 'details-dynamic', title: '动态详情' },
  { key: 'details-works', title: '作品详情' },
  { key: 'details-growth', title: '成长详情' },
  { key: 'details-homework', title: '作业详情' },
  { key: 'details-reading', title: '阅读详情' },
  
  // 其它一级页面
  { key: 'activities', title: '活动' },
  { key: 'personal-center', title: '个人中心' },

  // 作业提交
  { key: 'homework-list', title: '提交作业选择列表' },
  { key: 'requirement', title: '作业要求' },
  { key: 'submit', title: '提交作业' },

  // 登录&注册
  { key: 'login', title: '登录' },
  { key: 'callback', title: '登录回调' },

  // 我的相关
  { key: 'personal-center-dashboard', title: '关注|粉丝|推荐' },
