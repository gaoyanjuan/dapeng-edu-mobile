...
<style lang="less">
  .m-activities-card {
    ...
    .card-status {
      background: url('~@/assets/images/icon/mobile/activities-finish.png') no-repeat center center;
      width: 51px;
      height: 19px;
      position: absolute;
      right: 16px;
    ...
    .card-status-living {
      background: url('~@/assets/images/icon/mobile/activities-living.png') no-repeat center center;
    }
    .card-status-not {
      background: url('~@/assets/images/icon/mobile/activities-not.png') no-repeat center center;
    }
    .m-card-bottom {
      margin-top: 8px;
      position: relative;
