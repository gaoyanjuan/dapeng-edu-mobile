...
export default {
  ...
  data: () => ({
    homework: require('@/assets/images/icon/mobile/label-homework.png'),
    enter: require('@/assets/images/icon/mobile/label-enter.png'),
    topic: require('@/assets/images/icon/mobile/label-topic.png'),
  }),
  methods: {
    toWorkRequirement() {
