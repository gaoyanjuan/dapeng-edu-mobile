<template>
  <div class="m-works">
    ...
    <van-popup v-model="showMenusPopup" round overlay-class="menus__popup" :transition-appear="true">
      <nuxt-link v-if="propSquareType === 'HOMEWORK'" tag="div" :to="`/copy-form?taskId=${listItemData.id ? listItemData.id : '' }&id=${listItemData.user.userId ? listItemData.user.userId: '' }`" class="menus__popup__item">Ta抄作业</nuxt-link>
