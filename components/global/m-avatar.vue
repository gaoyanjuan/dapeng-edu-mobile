<template>
  <section class="m-avatar">
    ...
    <div class="avatar-right-side-wrap">
      ...
      <img v-if="(squareType === '作业' && pageName !== 'myRecommend' && pageName !== 'myHomework') || (pageName === 'myHomework' &&listItemData.approvedLevel === '0') || (pageName.indexOf('my') !== -1 && pageName !== 'myRecommend' && pageName !== 'myHomework' )" class="avatar-menus-more" :src="more" alt="更多" @click.stop="onOpenMenus"/>
    </div>
